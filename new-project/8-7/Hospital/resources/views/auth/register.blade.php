<x-guest-layout>
    ...
    @endif
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="ngaysinh" value="{{ __('Ngày sinh') }}" />
                <x-input id="ngaysinh" class="block mt-1 w-full" type="date" name="ngaysinh" :value="old('ngaysinh')" required autofocus autocomplete="ngaysinh" />
            </div>

            <div>
                <x-label for="cccd" value="{{ __('CCCD') }}" />
                <x-input id="cccd" class="block mt-1 w-full" type="text" name="cccd" :value="old('cccd')" required autofocus autocomplete="cccd" />
            </div>
