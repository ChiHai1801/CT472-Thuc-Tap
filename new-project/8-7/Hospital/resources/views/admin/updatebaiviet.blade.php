            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form action="/updatebaiviet/{{ $baiviet->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên bài viết</label>
                                <input type="text" name="tbv" class="form-control" value="{{$baiviet->name}}" onkeyup="ChangeToSlug();"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" rows="8" class="form-control" name="ttnd" id="ckeditor1"
                                    placeholder="Tóm tắt bài viết">{{$baiviet->ttnoidung}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nội dung bài viết</label>
                                <textarea style="resize: none" rows="8" class="form-control" name="ndbv" id="ckeditor2"
                                    placeholder="Nội dung bài viết">{{$baiviet->noidung}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hình ảnh bài viết</label>
                                <input type="file" name="image" class="form-control" id="exampleInputEmail1">
                            </div>
                            <button type="submit" name="add_category_product" class="btn btn-info active">Cập nhật bài
                                viết</button>
                        </form>
                    </div>
                </div>
