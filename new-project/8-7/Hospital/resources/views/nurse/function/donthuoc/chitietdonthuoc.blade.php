            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12 mt-5">
                  <a href="{{route('function/donthuoc/xemlsdonthuoc')}}" class="btn btn-warning" style="margin-right: 5px;">
                    <i class="fas fa-angle-double-left"></i> Quay lại
                  </a>
                  
                  <a href="{{ route('edit-indt', ['id'=>$userDetail->id]) }}" rel="noopener" target="_blank" class="btn btn-secondary float-right"><i class="fas fa-print"></i> Print</a>
                </div>
              </div>
              @csrf
            </form>
